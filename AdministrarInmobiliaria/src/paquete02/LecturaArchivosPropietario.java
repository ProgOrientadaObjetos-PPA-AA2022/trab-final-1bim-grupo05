 ...
 * @author kevin
 */
public class LecturaArchivosPropietario {
    private ObjectInputStream entrada;
    private ArrayList<Propietario> prop;
    private String nombreArchivo;
    private String identificador;
    private Propietario propietario_buscado;
    
    public LecturaArchivosPropietario(String n){
        nombreArchivo = n;
    ...
    public String toString() {
        String cadena = String.format("Lista de Propietario:\n");
        for (int i = 0; i < obtenerListaPropietarios().size(); i++) {
            Propietario propie = obtenerListaPropietarios().get(i);
            cadena = String.format("%s (%d) %s %s -identificador: %s \n", cadena, i + 1,
                    propie.obtenerNombre(), propie.obtenerApellidos(),
                    propie.obtenerIdentificacion());
        }
