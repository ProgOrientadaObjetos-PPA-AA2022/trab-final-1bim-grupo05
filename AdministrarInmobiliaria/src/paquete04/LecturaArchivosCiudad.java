 ...
 * @author kevin
 */
public class LecturaArchivosCiudad {
    private ObjectInputStream entrada;
    private ArrayList<Ciudad> ciu;
    private String nombreArchivo;
    private String identificador;
    private Ciudad ciudad_buscado;
    
    public LecturaArchivosCiudad(String n){
        nombreArchivo = n;
    ...
    public String toString() {
        ...
        for (int i = 0; i < obtenerListaCiudad().size(); i++) {
            Ciudad ciudad = obtenerListaCiudad().get(i);
            cadena = String.format("%s (%d) Nombre: %s Provincia: %s \n", cadena, i + 1,
